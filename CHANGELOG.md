...
- changed config properties from Supplier<Integer> / Supplier<Boolean> to IntSupplier / BooleanSupplier
...
## [26.1-5.0.4.1] - 2026-06-06
### Fixed
- fixed crash in creative mode if a mod has bucketable entities without a fluid like Alex's Mobs Cosmic Cod (all loaders)

## [26.1-5.0.4.0] - 2026-06-05
### Added
- all bucketable entity textures of Sea Life mod (all loaders)

## [26.1-5.0.3.0] - 2026-06-05
### Added
- all bucketable entity textures of Aquaculture 2 mod (all loaders)

## [26.1-5.0.2.1] - 2026-05-31
### Fixed
- fixed that empty buckets that could not be filled with water could be placed in the fuel slot of furnaces (all loaders)

## [26.1-5.0.2.0] - 2026-05-25
### Added
- added the possibility to fill empty buckets with water from wet sponges in furnaces (all loaders) (thanks to bixqa for the idea) #79

## [26.1-5.0.1.4] - 2026-05-23
### Fixed
- fixed startup warning about missing mixin refmap (all loaders)

## [26.1-5.0.1.3] - 2026-05-10
### Changed
...
- Updated JEI support (29.2.0.21) (NeoForge, Fabric/Quilt)
- temporary removed REI support until it is ported to 26.1 (NeoForge, Fabric/Quilt)

## [1.21.11-4.7.0.3] - 2026-04-24
### Fixed
- fixed dependencies in JitPack build

## [1.21.11-4.7.0.2] - 2026-04-24
### Fixed
- jitpack build was broken (another try)

## [1.21.11-4.7.0.1] - 2026-04-24
### Fixed
- jitpack build was broken

## [1.21.11-4.7.0.0] - 2026-04-24
### Added
- Nautilus taming and feeding support
...
- Updated JEI support (27.4.0.22) (NeoForge)
- Updated REI support (21.11.814) (NeoForge, Fabric/Quilt)

## [1.21.9-4.6.0.2] - 2026-04-22
### Fixed
- emptied buckets were not stackable with freshly crafted buckets (NeoForge)

## [1.21.9-4.6.0.1] - 2026-04-22
### Fixed
- game crashed after drinking a milk bucket or using a milk bucket in crafting recipes (NeoForge)

## [1.21.9-4.6.0.0] - 2026-04-22
### Changed
...
- Updated REI support (21.9.813) (NeoForge, Fabric/Quilt)
...
- Updated JEI support (21.4.0.27) (NeoForge)
- Updated REI support (19.0.809) (NeoForge, Fabric/Quilt)

## [1.21.4-4.3.0.1] - 2026-04-17
### Fixed
- fixed missing access widener setting in fabric.mod.json to fix startup crash (Fabric)
- fixed empty iterator handling in fluid helper (Fabric)
- fixed default texture fallback (Fabric / NeoForge)
