...
public class BucketLibTestMod {
    ...
    public static final DeferredHolder<Item, ?> ANTI_SALMON_BUCKET = registerBucket("anti_salmon_bucket", new UniversalBucketItem.Properties().deniedEntities(Collections.singletonList(EntityTypes.SALMON)));
    public static final DeferredHolder<Item, ?> ONLY_PUFFER_BUCKET = registerBucket("only_puffer_bucket", new UniversalBucketItem.Properties().allowedEntities(Collections.singletonList(EntityTypes.PUFFERFISH)));
