...
public class FabricUniversalBucketModel extends UniversalBucketModel {
    ...
    List<ItemModel> specialBaking(Fluid fluid, ItemTintSource bucketTint, TextureAtlasSprite baseSprite, TextureAtlasSprite otherContentSprite, TextureAtlasSprite fluidSprite, TextureAtlasSprite fluidMaskSprite, TextureAtlasSprite particleSprite) {
        ...
        if (baseSprite != null) {
            ...
            subModels.add(new BlockModelWrapper(List.of(bucketTint), quads, renderProperties, (stack) -> UNSORTED_TRANSLUCENT_ITEM));
        }
        if (otherContentSprite != null) {
            ...
            subModels.add(new BlockModelWrapper(List.of(), quads, renderProperties, (stack) -> UNSORTED_TRANSLUCENT_ITEM));
            ...
            subModels.add(new BlockModelWrapper(List.of(BucketFluidTint.INSTANCE), quads, renderProperties, (stack) -> UNSORTED_TRANSLUCENT_BLOCK));
        }
